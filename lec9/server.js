...
const server = http.createServer((req, res) => {
  ...
  res.setHeader('Access-Control-Allow-Origin', process.env.FRONTEND_URL);// Adjust the port if necessary
    ...
    req.on('end', () => {
      try {
        ...
        if (username === 'admin' && password === '111') {
          res.writeHead(200, {
            'Set-Cookie': 'token=123456; HttpOnly;Max-Age=60; SameSite=None; Secure ',
