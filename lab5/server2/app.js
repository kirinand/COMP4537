...
db.connect((err) => {
  ...
  const grantSelectSql = `REVOKE ALL PRIVILEGES ON ${constants.DB_NAME}.* FROM '{0}'@'${constants.DB_HOST}'; GRANT SELECT ON ${constants.DB_NAME}.patient TO '{0}'@'${constants.DB_HOST}';`
  const grantInsertSql = `REVOKE ALL PRIVILEGES ON ${constants.DB_NAME}.* FROM '{0}'@'${constants.DB_HOST}'; GRANT INSERT ON ${constants.DB_NAME}.patient TO '{0}'@'${constants.DB_HOST}';`
